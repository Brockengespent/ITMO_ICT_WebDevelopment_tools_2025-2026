"""
Микросервис парсера данных.
Отдельное FastAPI-приложение, запускаемое в собственном Docker-контейнере.
Принимает URL, парсит заголовок страницы и сохраняет в БД из ЛР1.

Доступен внутри Docker-сети по адресу http://parser:8001
"""
...
class Settings(BaseSettings):
    database_url: str = "postgresql://georgiy:mypassword@db:5432/timemanager"
